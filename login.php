<?php
    ...
    $users = array(
        "jarod" => array("pwd" => "1234", "rol" => "Administrator"),
        "link" => array("pwd" => "1235", "rol" => "Administrator"),
        "gert" => array("pwd" => "1236", "rol" => "Gebruiker")
    );
    ...
    if (isset($_POST["knop"])){
            ...
            $message = "Welkom " . $_SESSION["user"]["naam"] . " met de rol "
                ...
                $message = "Uw naam en/of wachtwoord is onjuist";
            }
    } else {
        $message = "Inloggen";
    }
